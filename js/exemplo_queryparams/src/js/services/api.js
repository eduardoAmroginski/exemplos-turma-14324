...
export async function fetchTopHeadlines() {
  try {
    ...
    // const endpoint = `https://newsapi.org/v2/everything?q=Deals: 24GB M5 MacBook Pro $125 off, AirPods Pro 2 $103 off, Apple Watch Solo Loops from $5, more&apiKey=${API_KEY}`
